    ...
    <div>
      <input
        ...
        style={{
          ...
          fontSize: '0.9rem', fontFamily: 'Outfit, sans-serif', marginBottom: '1rem', outline: 'none',
        }}
      />
          ...
          {filtered.map(dog => (
            ...
            >
              <div style={{
                ...
                {dog.photo_url
                  ? <img src={dog.photo_url} style={{ width: '100%', height: '100%', objectFit: 'cover', objectPosition: 'center top' }} />
                  : <span>🐕</span>}
              </div>
              <div style={{ flex: 1 }}>
