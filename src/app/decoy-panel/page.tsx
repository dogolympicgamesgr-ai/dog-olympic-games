...
export default function DecoyPanelPage() {
  ...
  useEffect(() => {
    async function init() {
      ...
      if (!roles?.includes('decoy')) { router.push('/dashboard'); return }
      setChecking(false)
    }
    init()
  }, [])
      ...
      <div style={{ maxWidth: '700px', margin: '0 auto', padding: '0 1.5rem' }}>
        ...
        <div style={{
          ...
          <p style={{ color: 'var(--text-secondary)', fontSize: '0.9rem', maxWidth: '380px', margin: '0 auto' }}>
            {t(
              'Εδώ θα μπορείς να βλέπεις τους αγώνες που έχεις οριστεί decoy, να αποδέχεσαι ή να απορρίπτεις προσκλήσεις.',
              'Here you will be able to view events where you are assigned as decoy and accept or decline invitations.'
            )}
          </p>
        </div>
